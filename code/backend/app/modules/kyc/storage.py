...
class DocumentStorage:
    ...
    def __init__(self, storage_path: str | None = None):
        ...
        # In Docker, STORAGE_PATH is always set to /data/documents (volume mount)
        # Always use STORAGE_PATH when it's different from DEV default
        elif settings.STORAGE_PATH and settings.STORAGE_PATH != "./data/documents":
    ...
    async def verify_integrity(
        self, session_id: str, filename: str, expected_hash: str
    ) -> bool:
