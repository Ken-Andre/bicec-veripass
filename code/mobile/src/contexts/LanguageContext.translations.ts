...
export const translations: Record<string, Record<Language, string>> = {
    ...
    'liveness.challenge.blink': { fr: 'Clignez des yeux', en: 'Blink your eyes' },
    'liveness.challenge.turn_left': { fr: 'Tournez la tête à gauche', en: 'Turn your head left' },
    'liveness.challenge.turn_right': { fr: 'Tournez la tête à droite', en: 'Turn your head right' },
    'liveness.guidance.blink': { fr: 'Gardez les yeux ouverts, puis clignez une fois.', en: 'Keep your eyes open, then blink once.' },
    'liveness.guidance.turn.left': { fr: 'Tournez la tête vers votre gauche.', en: 'Turn your head to your left.' },
    'liveness.guidance.turn.more': { fr: 'Encore un peu vers votre gauche.', en: 'A little more to your left.' },
    'liveness.guidance.turn.other_side': { fr: "Tournez de l'autre côté, vers votre gauche.", en: 'Turn the other way, to your left.' },
    'liveness.guidance.validating': { fr: "Validation de l'action en cours", en: 'Validating action' },
    'liveness.guidance.step_validated': { fr: 'Étape validée', en: 'Step validated' },
    'liveness.face.not_detected': { fr: "Visage non détecté. Placez-vous dans l'ovale.", en: 'Face not detected. Place your face in the oval.' },
    'liveness.camera.error': { fr: 'Erreur caméra', en: 'Camera error' },
    'liveness.success.title': { fr: 'Vérification réussie', en: 'Verification successful' },
    'liveness.success.subtitle': { fr: 'Votre identité a été confirmée.', en: 'Your identity has been confirmed.' },
    ...
    // Address
    'address.title': { fr: 'Adresse de résidence', en: 'Residential address' },
    'address.gps.notice': { fr: 'Indiquez votre adresse actuelle pour la validation KYC.', en: 'Enter your current address for KYC validation.' },
    'address.gps.title': { fr: 'Localisation GPS', en: 'GPS location' },
    'address.gps.required': { fr: 'Requise pour validation', en: 'Required for validation' },
    'address.gps.capture': { fr: 'Capturer', en: 'Capture' },
    'address.gps.loading': { fr: 'Acquisition...', en: 'Locating...' },
    'address.gps.retake': { fr: 'Reprendre', en: 'Retake' },
    'address.gps.captured': { fr: 'Position capturée', en: 'Location captured' },
    'address.gps.outOfZone': { fr: 'Position capturée hors zone', en: 'Captured location is out of range' },
    'address.gps.unsupported': { fr: "La géolocalisation n'est pas disponible sur cet appareil.", en: 'Geolocation is not available on this device.' },
    'address.gps.outOfCameroon': { fr: 'Position hors du Cameroun. Vérifiez votre localisation.', en: 'Location is outside Cameroon. Check your GPS position.' },
    'address.gps.error': { fr: "Impossible d'obtenir la position. Vérifiez les permissions GPS.", en: 'Unable to get your location. Check GPS permissions.' },
    'address.region': { fr: 'Région', en: 'Region' },
    'address.city': { fr: 'Ville', en: 'City' },
    'address.quartier': { fr: 'Quartier', en: 'Neighbourhood' },
    'address.lieuDit': { fr: 'Lieu-dit', en: 'Landmark' },
    'address.lieuDit.placeholder': { fr: 'Lieu-dit, rue, numéro', en: 'Landmark, street, number' },
    'address.geo.fallback': { fr: 'Mode secours actif : certaines localités restent disponibles.', en: 'Fallback mode active: some locations remain available.' },
    'address.geo.unavailable': { fr: 'Service de localités temporairement indisponible. Réessayez.', en: 'Location service is temporarily unavailable. Try again.' },
    'address.blocker.gps': { fr: 'Capturez votre position GPS pour continuer.', en: 'Capture your GPS location to continue.' },
    'address.blocker.region': { fr: 'Sélectionnez votre région.', en: 'Select your region.' },
    'address.blocker.city': { fr: 'Sélectionnez votre ville.', en: 'Select your city.' },
    'address.blocker.quartier': { fr: 'Sélectionnez votre quartier.', en: 'Select your neighbourhood.' },
    ...
    'settings.officialChannel': { fr: 'Messages officiels', en: 'Official messages' },
    'settings.officialChannelHelp': { fr: 'Choisissez le canal pour les informations importantes : carte à récupérer, passage en agence, politiques mises à jour.', en: 'Choose the channel for important information: card pickup, agency visit, updated policies.' },
    'settings.officialChannelError': { fr: 'Preference impossible a enregistrer.', en: 'Unable to save preference.' },
    'settings.serviceUnavailable': { fr: 'Service temporairement indisponible. Réessayez dans quelques instants.', en: 'Service temporarily unavailable. Try again shortly.' },
    'settings.push.partialFailure': { fr: 'Autorisation acceptée, mais synchronisation impossible. Réessayez.', en: 'Permission accepted, but sync failed. Try again.' },
    'settings.push.disabled': { fr: 'Notifications push désactivées.', en: 'Push notifications disabled.' },
    'settings.push.disabledLocal': { fr: 'Notifications désactivées sur cet appareil. Synchronisation serveur en attente.', en: 'Notifications disabled on this device. Server sync pending.' },
