...
export const translations: Record<string, Record<Language, string>> = {
    ...
    'settings.officialChannelHelp': { fr: 'Choisissez le canal pour les informations importantes: carte a recuperer, passage en agence, politiques mises a jour.', en: 'Choose the channel for important information: card pickup, agency visit, updated policies.' },
