...
export function TransferReceiveScreen() {
  ...
  // =====================================================================
  // PRODUCTION SAFETY — Données bancaires mockées désactivées temporairement.
  // Le client n'a pas accès à ces valeurs tant que les comptes de test
  // réels ne sont pas chargés côté serveur. À réactiver uniquement après
  // validation conformité et intégration core banking.
  // =====================================================================
  // const ribInfo = {
  //   bank: '10001',
  //   branch: '00023',
      ...
      <div className="space-y-6 pt-2">
        ...
        <div className="bg-card border border-border rounded-2xl p-6 text-center">
          <p className="text-sm text-muted-foreground">
            Le RIB sera disponible prochainement.
          </p>
        </div>
      </div>
    </ScreenLayoutV2>
